...
```
From the scatterlot between alcohol and quality we can see alcohol quality at 5,6,7 have range of alcohol content from 7 percent to 13 percent. The lower quality wine of 5 and below have alcohol content predominently in the range of 7 and 11. 
...
wine$qualityordered <- factor(wine$quality)

ggplot(aes(x= qualityordered, y = alcohol), data = wine)+
geom_boxplot()

ggplot(aes(x = qualityordered, y = pH),data = wine)+
  geom_boxplot()
...
ggplot(aes(x = quality, y = volatile.acidity),data = subset(wine,volatile.acidity <= quantile(volatile.acidity,0.95)))+
  geom_boxplot()

ggplot(aes(x = quality, y = residual.sugar),data = subset(wine,residual.sugar <= quantile(residual.sugar,0.99)))+
  geom_boxplot()

ggplot(aes(x = quality, y = total.sulfur.dioxide),data = subset(wine,total.sulfur.dioxide <= quantile(total.sulfur.dioxide,0.99)))+
  geom_boxplot()

ggplot(aes(x = quality, y = sulphates),data = subset(wine,sulphates <= quantile(sulphates,0.99)))+
  geom_boxplot()
...
ggplot(aes(x = quality, y = chlorides),data = subset(wine,chlorides <= quantile(chlorides,0.95)))+
  geom_boxplot()
